...
% Define the inputs.
%--------------------------------------------------------------------------
inputs.IMAGE     = 'Nyack.tif';
inputs.GRNDTRUTH = 'Nyack_GTruth.tif';
inputs.nclasses  = 9;   % number of classes
...
figure(1)
 ...
 figure(2)
    ...
    %colorbar('YTickLabel',{'pasture','willow','cottonwood','conifers','water','cobble','regen','deciduous','road'})
figure(3)
